...
from pwnbao.core.elf_runtime import auto_patch_elf, is_elf_file
from pwnbao.core.workspace import PwnWorkspace, AddressKind, TypedAddress, WorkspaceVariable
from pwnbao.core.workbench import BinaryInspector
from pwnbao.core.session import TargetContext, import_target
from pwnbao.core.wsl import WslToolRunner
from pwnbao.core.cli_runner import CliToolService, WslCliExecutor
from pwnbao.core.gadgets import Gadget, GadgetShelf, parse_ropgadget_output, search_gadgets
...
from pwnbao.core.workbench import SyscallPlanner
from pwnbao.features.conversion.converters import int_report, bytes_report
from pwnbao.features.iofile.layouts import GlibcFileLayoutDatabase
from pwnbao.features.iofile.snapshot import FileSnapshot
from pwnbao.features.iofile.constraints import FileConstraintEngine
from pwnbao.features.iofile.analyzer import analyze_file_source
from pwnbao.features.heapviz.allocators.profiles import ALLOCATOR_PROFILE_REVISION, profile_list
from pwnbao.features.heapviz.bridge_session import HeapSession
from pwnbao.features.heapviz.dataset import validate_case
from pwnbao.features.heapviz.templates import HEAP_TEMPLATES
from pwnbao.core.pwndbg_manager import PWNDBG_MOGAI_VERSION, PwndbgManager
...
class ElectronBridge:
    ...
    def rpc_blocks_list(self, params: dict) -> dict:
        from pwnbao.core.models import BlockCatalog
    ...
    def rpc_clib_catalog(self, params: dict) -> dict:
        ...
        from pwnbao.core.models import CFunctionCatalog
    ...
    def rpc_command_templates(self, params: dict) -> dict:
        from pwnbao.features.commands.templates import WSL_COMMAND_TEMPLATES, GDB_COMMAND_TEMPLATES
    ...
    def rpc_debug_launch(self, params: dict) -> dict:
        ...
        work_dir = project_path / ".pwnbao" / "work"
