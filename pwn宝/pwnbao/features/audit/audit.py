...
from pwnbao.features.audit.heap_state import run_rules
from pwnbao.features.audit.model import Diagnostic, SEVERITY_ERROR
from pwnbao.features.audit.quickfix import apply_quick_fix
