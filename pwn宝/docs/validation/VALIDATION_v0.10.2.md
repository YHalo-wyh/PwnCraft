...
- `python -m ruff check pwnbao tests artifacts/ui_audit/render_v0102.py artifacts/ui_audit/render_overlap_v0102.py artifacts/ui_audit/render_reuse_v0102.py`
  - `All checks passed!`
...
- rewritten original executed and printed `pwnbao-patchelf-ok`;
...
- Verified the pinned SHA256, extracted it to `$HOME/.local/share/pwnbao/pwndbg/2026.07.29`, and confirmed `is_installed() == True`.
