...
from pwnbao.features.heapviz import AllocatorConfig,GlibcHeapEngine,analyze_heap_source
base=Path(__file__).resolve().parent
profile=json.loads((base/'traditional.pwnbao-helper.json').read_text('utf8'))
