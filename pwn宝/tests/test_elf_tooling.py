...
from pwnbao.core.elf_runtime import auto_patch_elf, discover_runtime_pair, is_elf_file
from pwnbao.core.pwndbg_manager import (
    PWNDBG_ASSETS,
...
from pwnbao.core.wsl import ToolResult, WslToolRunner
...
class ElfToolingTests(unittest.TestCase):
    ...
    def test_wsl_runner_uses_exec_mode_to_preserve_tool_arguments(self) -> None:
        ...
        with patch("pwnbao.core.wsl.subprocess.run", return_value=completed) as run:
    ...
    def test_pwndbg_release_is_pinned_and_launcher_targets_wsl_portable(self) -> None:
        ...
        self.assertIn("$HOME/.local/share/pwnbao/pwndbg-mogai", spec.extension_wsl_path)
