...
from pwnbao.core.gadgets import GadgetShelf, parse_gadget_line, parse_ropgadget_output, search_gadgets
from pwnbao.core.rop import ROPChain, RegisterState, StackState
from pwnbao.core.workbench import SyscallPlanner, encode_value, parse_checksec_output, search_palette
from pwnbao.core.syscalls import lookup_syscall, parse_seccomp_policy
from pwnbao.core.tool_actions import ActionType, ToolAction, ToolActionRegistry, default_tool_actions
from pwnbao.core.truth_providers import ELFProvider
from pwnbao.core.workspace import AddressKind, PwnWorkspace, TypedAddress, WorkspaceVariable
...
class WorkbenchCoreTests(unittest.TestCase):
    ...
    def test_workspace_roundtrip_preserves_typed_variable_and_marks_runtime_stale(self) -> None:
        ...
        with TemporaryDirectory() as temporary:
            ...
            self.assertTrue(path.name.endswith(".pwnbao"))
