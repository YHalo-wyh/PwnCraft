...
_TABLES: dict[str, dict[str, SyscallSpec]] = {
    "amd64": {
        ...
        "execveat": SyscallSpec("execveat", 322, ("rdi", "rsi", "rdx", "r10"), "int execveat(int dirfd, const char *path, char *const argv[], char *const envp[], int flags)"),
        "fork": SyscallSpec("fork", 57, (), "pid_t fork(void)"),
        "vfork": SyscallSpec("vfork", 58, (), "pid_t vfork(void)"),
        "clone": SyscallSpec("clone", 56, ("rdi", "rsi", "rdx", "r10", "r8"), "int clone(unsigned long flags, void *stack, int *parent_tid, int *child_tid, unsigned long tls)"),
        "exit_group": SyscallSpec("exit_group", 231, ("rdi",), "void exit_group(int status)"),
        "brk": SyscallSpec("brk", 12, ("rdi",), "void *brk(void *addr)"),
        "munmap": SyscallSpec("munmap", 11, ("rdi", "rsi"), "int munmap(void *addr, size_t length)"),
    },
    "i386": {
        ...
        "execveat": SyscallSpec("execveat", 358, ("ebx", "ecx", "edx", "esi"), "int execveat(int dirfd, const char *path, char *const argv[], char *const envp[], int flags)", return_register="eax", architecture="i386"),
        "fork": SyscallSpec("fork", 2, (), "pid_t fork(void)", return_register="eax", architecture="i386"),
        "vfork": SyscallSpec("vfork", 190, (), "pid_t vfork(void)", return_register="eax", architecture="i386"),
        "clone": SyscallSpec("clone", 120, ("ebx", "ecx", "edx", "esi", "edi"), "int clone(unsigned long flags, void *stack, int *parent_tid, void *child_tid, unsigned long tls)", return_register="eax", architecture="i386"),
        "exit_group": SyscallSpec("exit_group", 252, ("ebx",), "void exit_group(int status)", return_register="eax", architecture="i386"),
        "brk": SyscallSpec("brk", 45, ("ebx",), "void *brk(void *addr)", return_register="eax", architecture="i386"),
        "munmap": SyscallSpec("munmap", 91, ("ebx", "ecx"), "int munmap(void *addr, size_t length)", return_register="eax", architecture="i386"),
        "openat": SyscallSpec("openat", 295, ("ebx", "ecx", "edx", "esi"), "int openat(int dirfd, const char *path, int flags, mode_t mode)", return_register="eax", architecture="i386"),
    },
    "aarch64": {
