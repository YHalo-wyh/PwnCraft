...
target      : F:\pwn宝\pwncraft\artifacts\gw-training\intelpwn\challenge_tcache  sha256=ba22f61d58688592…  amd64/64-bit  endian=little
mitigations : PIE=OFF NX=ON CANARY=OFF RELRO=PARTIAL FORTIFY=OFF
provenance  : DERIVED（ELF 字节 / objdump / 重定位；离线、无模型推断）
evidence    :
  - 0x40161c: call system
  - 参数地址 0x402067
  - stack_truth=missing
gaps        :
...
TARGET = 'F:\\pwn宝\\pwncraft\\artifacts\\gw-training\\intelpwn\\challenge_tcache'
