...
target      : F:\pwn宝\pwncraft\artifacts\greatwall\HashArchive\x\pwn  sha256=615ccfa2d5a6c991…  amd64/64-bit  endian=little
...
TARGET = 'F:\\pwn宝\\pwncraft\\artifacts\\greatwall\\HashArchive\\x\\pwn'
...
UNRESOLVED = ['OFFSET（到保存返回地址的填充长度）', 'POP_RAX（sigreturn 号需要）', 'BINSH（壳字符串地址）']
