...
- AI prompt 从 `pwncraft-heap-ai-v8-helper-first` 演进到 `pwncraft-heap-ai-v10-negative-rules`：
...
```powershell
python -m pwncraft.tools.heap_ai_corpus artifacts\heap_ai_writeups\ruanan_finals_v1\manifest.json `
