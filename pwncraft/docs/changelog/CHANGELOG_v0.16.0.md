...
本轮严格按《PwnCraft下一代 Pwn Workbench 大改开发任务》完成 Phase 2（Stack + ROP）接线与可验证子集收口。
...
- 打开 `.pwncraft` 后 Stack Canvas、ROP Builder、ret2libc、Leak Manager 订阅 `workspace_merged` 并刷新，runtime 继续标 stale。
