...
QT_QPA_PLATFORM=windows python -m pwncraft.tools.ui_audit_v013
QT_QPA_PLATFORM=offscreen python -m pwncraft.tools.performance_audit_v013
python3 -m pwncraft.tools.pwndbg_interactive_performance
```
...
- Executable: `dist/pwncraft.exe` (60,256,304 bytes).
