...
from pwncraft.features.audit.audit import audit_exp  # noqa: E402
from pwncraft.features.audit.quickfix import apply_quick_fix  # noqa: E402
from pwncraft.features.audit.values import SymbolicValue, ValueKind  # noqa: E402
...
'''
    ...
    ir, err = __import__("pwncraft.features.audit.extract", fromlist=["x"])         .extract_exploit_ir(exp)
    assert err is None
