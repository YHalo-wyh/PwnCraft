...
from pwncraft.core.static_facts import (
    parse_objdump_plt,
    parse_objdump_relocations,
    parse_readelf_dynsyms,
)
from pwncraft.core.workbench import default_palette_entries, search_palette
...
class MergeSavedTests(unittest.TestCase):
    def test_merge_restores_sections_and_keeps_identity(self) -> None:
        ...
        source.set_variable(
            __import__("pwncraft.core.workspace", fromlist=["WorkspaceVariable"]).WorkspaceVariable(
