...
from pwncraft.features.ai import (
    AIAnalysisRequest,
    AIKnowledgeStore,
    AIProposal,
    CorpusEvaluator,
...
from pwncraft.features.heapviz import GlibcHeapEngine, HeapOperationKind, analyze_heap_source, build_allocator_config
from pwncraft.tools.heap_ai_corpus import main as corpus_main
...
"""]
    ...
    def test_cli_rejects_wrong_loaded_model_before_analysis(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "pwncraft.tools.heap_ai_corpus.OpenAICompatibleProvider.list_models",
