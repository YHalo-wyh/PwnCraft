...
from pwncraft.core.c_source_ir import extract_c_callsites  # noqa: E402
from pwncraft.core.value_ir import K_CONST, K_LOAD, K_STACK, K_UNKNOWN  # noqa: E402
from pwncraft.core.x86_trace import trace_callsites  # noqa: E402
...
def test_o1_both_frees_unify_to_same_object() -> None:
    from pwncraft.core.x86_trace import _slot_objectref
